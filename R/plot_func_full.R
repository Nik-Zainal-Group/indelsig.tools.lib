...
plots_indelprofile_full<- function(muts_basis,colnum,text_size=3, h=NULL,w=NULL, print_Xlabel=T, print_pdf = T, print_png = F, outputname){
  ...
  if(length(cnames)>1){
    ...
    if(is.null(outputname)==F){
      ...
      if(print_pdf){
            filename <- paste0(outputname, ".pdf")
            grDevices::pdf(file=filename, onefile=TRUE,width=w,height=h, units = "in", res = 300)
...
gen_plot_catalougefull_single_sd <- function (muts_basis, text_size=2, plot_title, sd=NULL, specific_indel_type = NULL) 
{
  indel_template_type_4_full_figurelabel <- structure(list(IndelType = c("A[Ins(C):R0]A", 
                                                                         "A[Ins(C):R0]G", "A[Ins(C):R0]T", "A[Ins(C):R1]A", "A[Ins(C):R1]G", 
                                                                         "A[Ins(C):R1]T", "A[Ins(C):R2]A", "A[Ins(C):R2]G", "A[Ins(C):R2]T", 
                                                                         "A[Ins(C):R3]A", "A[Ins(C):R3]G", "A[Ins(C):R3]T", "A[Ins(C):R4]A", 
                                                                         "A[Ins(C):R4]G", "A[Ins(C):R4]T", "A[Ins(C):R5]A", "A[Ins(C):R5]G", 
                                                                         ...
                                                                         "G[Ins(T):R7]G", "G[Ins(T):R8]A", "G[Ins(T):R8]C", "G[Ins(T):R8]G", 
                                                                         "G[Ins(T):R9]A", "G[Ins(T):R9]C", "G[Ins(T):R9]G", "Ins(2,4):M", 
                                                                         "Ins(5,):M", "Ins2:U1:R0", "Ins3:U1:R0", "Ins4:U1:R0", 
                                                                         ...
                                                                         "Ins(5,):U(3,):R4", "Ins(5,):U(3,):R(5,9)", "A[Del(C):R1]A", 
                                                                         "A[Del(C):R1]G", "A[Del(C):R1]T", "A[Del(C):R2]A", "A[Del(C):R2]G", 
                                                                         ...
                                                                         "A[Del(C):R8]A", "A[Del(C):R8]G", "A[Del(C):R8]T", "A[Del(C):R9]A", 
                                                                         "A[Del(C):R9]G", "A[Del(C):R9]T", "G[Del(C):R1]A", "G[Del(C):R1]G", 
                                                                         ...
                                                                         "G[Del(C):R8]G", "G[Del(C):R8]T", "G[Del(C):R9]A", "G[Del(C):R9]G", 
                                                                         "G[Del(C):R9]T", "T[Del(C):R1]A", "T[Del(C):R1]G", "T[Del(C):R1]T", 
                                                                         ...
                                                                         "T[Del(C):R8]T", "T[Del(C):R9]A", "T[Del(C):R9]G", "T[Del(C):R9]T", 
                                                                         ...
                                                                         "A[Del(T):R9]A", "A[Del(T):R9]C", "A[Del(T):R9]G", "C[Del(T):R1]A", 
                                                                         ...
                                                                         "C[Del(T):R8]A", "C[Del(T):R8]C", "C[Del(T):R8]G", "C[Del(T):R9]A", 
                                                                         "C[Del(T):R9]C", "C[Del(T):R9]G", "G[Del(T):R1]A", "G[Del(T):R1]C", 
                                                                         ...
                                                                         "G[Del(T):R8]C", "G[Del(T):R8]G", "G[Del(T):R9]A", "G[Del(T):R9]C", 
                                                                         "G[Del(T):R9]G", "Del2:U1:R1", "Del3:U1:R1", "Del4:U1:R1", 
                                                                         ...
                                                                         "Del4:U4:R(5,9)", "Del5:U1:R(6,9)", "Del5:U5:R2", "Del5:U5:R3", 
                                                                         ...
                                                                         "Del(7,):M5", "Del(7,):M(6,)", "Complex(0,1)", "Complex(2,5)", 
                                                                         "Complex(6,10)", "Complex(11,20)", "Complex(21,)"), Indel = c("Ins(C)", 
                                                                                                                                       ...
                                                                                                                                       "Ins(T)", "Ins(T)", "Ins(T)", "Ins(T)", "Ins(T)", "Ins(T)", 
                                                                                                                                       "Ins(T)", "Ins(T)", "Ins(T)", "Ins(T)", "Ins(T)", "Ins(T)", 
                                                                                                                                       "Ins(T)", "Ins(T)", "Ins(T)", "Ins(T)", "Ins(T)", "Ins(2,):R(0,9)", 
                                                                                                                                       ...
                                                                                                                                       "Ins(2,):R(0,9)", "Ins(2,):R(0,9)", "Ins(2,):R(0,9)", 
                                                                                                                                       "Ins(2,):R(0,9)", "Ins(2,):R(0,9)", "Ins(2,):R(0,9)", 
                                                                                                                                       "Ins(2,):R(0,9)", "Ins(2,):R(0,9)", "Del(C)", "Del(C)", 
                                                                                                                                       ...
                                                                                                                                       "Del(T)", "Del(T)", "Del(T)", "Del(T)", "Del(T)", "Del(T)", 
                                                                                                                                       "Del(T)", "Del(T)", "Del(T)", "Del(T)", "Del(T)", "Del(T)", 
                                                                                                                                       "Del(T)", "Del(T)", "Del(T)", "Del(T)", "Del(2,):R(1,9)", 
                                                                                                                                       ...
                                                                                                                                       "Del(2,):R(1,9)", "Del(2,):R(1,9)", "Del(2,):R(1,9)", 
                                                                                                                                       "Del(2,):R(1,9)", "Del(2,):R(1,9)", "Del(2,):R(1,9)", 
                                                                                                                                       "Del(2,):R(1,9)", "Del(2,):R(1,9)", "Del(2,):M(1,)", 
                                                                                                                                       "Del(2,):M(1,)", "Del(2,):M(1,)", "Del(2,):M(1,)", "Del(2,):M(1,)", 
                                                                                                                                       "Del(2,):M(1,)", "Del(2,):M(1,)", "Del(2,):M(1,)", "Del(2,):M(1,)", 
                                                                                                                                       "Del(2,):M(1,)", "Del(2,):M(1,)", "Del(2,):M(1,)", "Del(2,):M(1,)", 
                                                                                                                                       "Del(2,):M(1,)", "Del(2,):M(1,)", "Del(2,):M(1,)", "Del(2,):M(1,)", 
                                                           ...
                                                           Indel3 = c("Insertion", "Insertion", "Insertion", "Insertion", 
                                                                      ...
                                                                      "Deletion", "Deletion", "Deletion", "Deletion", "Deletion", 
                                                                      "Deletion", "Deletion", "Deletion", "Deletion", "Deletion", 
                                                                      "Deletion", "Complex", "Complex", "Complex", "Complex", 
                                                                      "Complex"), Figlabel = c("A[Ins(C):R0]A", "A[Ins(C):R0]G", 
                                                                                               ...
                                                                                               "A[Ins(C):R8]T", "A[Ins(C):R9]A", "A[Ins(C):R9]G", 
                                                                                               "A[Ins(C):R9]T", "G[Ins(C):R0]A", "G[Ins(C):R0]G", 
                                                                                               ...
                                                                                               "G[Ins(C):R8]T", "G[Ins(C):R9]A", "G[Ins(C):R9]G", 
                                                                                               "G[Ins(C):R9]T", "T[Ins(C):R0]A", "T[Ins(C):R0]G", 
                                                                                               ...
                                                                                               "T[Ins(C):R8]T", "T[Ins(C):R9]A", "T[Ins(C):R9]G", 
                                                                                               "T[Ins(C):R9]T", "A[Ins(T):R0]A", "A[Ins(T):R0]C", 
                                                                                               ...
                                                                                               "A[Ins(T):R8]G", "A[Ins(T):R9]A", "A[Ins(T):R9]C", 
                                                                                               "A[Ins(T):R9]G", "C[Ins(T):R0]A", "C[Ins(T):R0]C", 
                                                                                               ...
                                                                                               "C[Ins(T):R8]G", "C[Ins(T):R9]A", "C[Ins(T):R9]C", 
                                                                                               "C[Ins(T):R9]G", "G[Ins(T):R0]A", "G[Ins(T):R0]C", 
                                                                                               ...
                                                                                               "G[Ins(T):R8]G", "G[Ins(T):R9]A", "G[Ins(T):R9]C", 
                                                                                               "G[Ins(T):R9]G", "Ins(2,4):M", "Ins(5,):M", "Ins2:U1:R0", 
                                                                                               ...
                                                                                               "A[Del(C):R8]G", "A[Del(C):R8]T", "A[Del(C):R9]A", 
                                                                                               "A[Del(C):R9]G", "A[Del(C):R9]T", "G[Del(C):R1]A", 
                                                                                               ...
                                                                                               "G[Del(C):R8]G", "G[Del(C):R8]T", "G[Del(C):R9]A", 
                                                                                               "G[Del(C):R9]G", "G[Del(C):R9]T", "T[Del(C):R1]A", 
                                                                                               ...
                                                                                               "T[Del(C):R8]G", "T[Del(C):R8]T", "T[Del(C):R9]A", 
                                                                                               "T[Del(C):R9]G", "T[Del(C):R9]T", "A[Del(T):R1]A", 
                                                                                               ...
                                                                                               "A[Del(T):R8]C", "A[Del(T):R8]G", "A[Del(T):R9]A", 
                                                                                               "A[Del(T):R9]C", "A[Del(T):R9]G", "C[Del(T):R1]A", 
                                                                                               ...
                                                                                               "C[Del(T):R8]C", "C[Del(T):R8]G", "C[Del(T):R9]A", 
                                                                                               "C[Del(T):R9]C", "C[Del(T):R9]G", "G[Del(T):R1]A", 
                                                                                               ...
                                                                                               "G[Del(T):R8]C", "G[Del(T):R8]G", "G[Del(T):R9]A", 
                                                                                               "G[Del(T):R9]C", "G[Del(T):R9]G", "Del2:U1:R1", "Del3:U1:R1", 
                                                                                               ...
                                                                                               "Del5:U1:R(6,9)", "Del5:U5:R2", "Del5:U5:R3", "Del5:U5:R4", 
                                                                                               "Del5:U5:R(5,9)", "Del(6,):U1:R(7,9)", "Del(6,):U2:R(4,9)", 
                                                                                               "Del(6,):U3:R(3,9)", "Del(6,):U(4,):R(2,9)", "Del2:M1", 
                                                      ...
                                                      class = "data.frame", row.names = c(NA, -476L))
  muts_basis_melt <- reshape2::melt(muts_basis, "IndelType")
  muts_basis_melt <- merge(indel_template_type_4_full_figurelabel, 
  ...
  muts_basis_melt$Sample <- as.character(muts_basis_melt$Sample)
  if(!is.null(sd)){
    muts_basis_melt <- merge(muts_basis_melt, sd, by.x= "IndelType", by.y=0)
  }
  if(!is.null(specific_indel_type)){
    muts_basis_melt <- muts_basis_melt[muts_basis_melt$Indel == specific_indel_type,,drop= F]
  }
  ...
  names(indel_mypalette_fill) <-  unique(indel_template_type_4_full_figurelabel$Indel)
  
  
  if(!is.null(specific_indel_type)){
    indel_mypalette_fill <- indel_mypalette_fill[names(indel_mypalette_fill) == specific_indel_type]
    indel_template_type_4_full_figurelabel <- indel_template_type_4_full_figurelabel[indel_template_type_4_full_figurelabel$Indel == specific_indel_type,,drop=F]
  }
  ...
  order_entry <- c("Ins(C)", "Ins(T)", "Ins(2,):R(0,9)", "Del(C)", 
                   "Del(T)", "Del(2,):R(1,9)", "Del(2,):M(1,)", "Complex")
  
  if(!is.null(specific_indel_type)){
    order_entry <- specific_indel_type
  }
  ...
  if(!is.null(sd)){
    ...
    blocks$ymin <- max(muts_basis_melt$freq +  muts_basis_melt$data_476_sd) * 1.08
    blocks$ymax <- max(muts_basis_melt$freq + muts_basis_melt$data_476_sd) * 1.14
  }else{
    blocks$ymin <- max(muts_basis_melt$freq) * 1.08
    blocks$ymax <- max(muts_basis_melt$freq) * 1.14
  }
  if(!is.null(specific_indel_type)){
    
    
    pos_l <- c("1bp C", "1bp T", ">=2bp", "1bp C", "1bp T", 
               ">=2bp", "Mh", "X")
    ...
    position_to_keep <- which(names(pos_l) == specific_indel_type)
    
    
    
    blocks$labels <- c("1bp C", "1bp T", ">=2bp", "1bp C", "1bp T", 
                       ">=2bp", "Mh", "X")[position_to_keep]
    
    
    blocks$cl <- c("black", "black", "black", "white", "white", 
                   "white", "white", "white")[position_to_keep]
    
    
    indel_mypalette_fill3 <- c("#000000", "#888888", "#DDDDDD")
    entry3 <- table(indel_template_type_4_full_figurelabel$Indel3)
    order_entry3 <- c("Insertion", "Deletion", "Complex")
    names(indel_mypalette_fill3) <- order_entry3
    

    indel_mypalette_fill3 <- indel_mypalette_fill3[names(entry3)]
    ...
    if(!is.null(sd)){
      blocks3$ymin <- max(muts_basis_melt$freq + muts_basis_melt$data_476_sd) * 1.14
      blocks3$ymax <- max(muts_basis_melt$freq + muts_basis_melt$data_476_sd) * 1.20
    }else{
      blocks3$ymin <- max(muts_basis_melt$freq) * 1.14
      blocks3$ymax <- max(muts_basis_melt$freq) * 1.20
      
    }
    ### let's hardcode here
    
    if(names(entry3) == "Insertion"){
      blocks3$labels <- "Insertion"
      blocks3$cl <- "black"
    }else if(names(entry3) == "Deletion"){
      blocks3$labels <- "Deletion"
      blocks3$cl <- "white"
    }else if(names(entry3) == "Complex"){
      blocks3$labels <- "X"
      blocks3$cl <- "white"
    }
    ...
    indel_mypalette_fill_all <- c("#000000", "#762A83", "#EE3377", 
                                  "#004488", "#997700", "#EE99AA", "#6699CC", 
                                  "#EECC66")
    
    
    names(indel_mypalette_fill_all) <-  c(
      "Complex",
      "Del(2,):M(1,)",
      "Del(2,):R(1,9)", 
      "Del(C)",
  ...
  if(!is.null(sd)){
    p <- p + geom_errorbar(aes(ymin = freq-data_476_sd, ymax = freq+data_476_sd),stat = "identity",   position = "dodge", width = 0.7, linewidth = 0.1)
  }
